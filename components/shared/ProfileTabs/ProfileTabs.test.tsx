...
describe('ProfileTabs', () => {
  it('renders all tabs', () => {
    render(<ProfileTabs tabs={mockTabs} activeTab="repositories" onTabChange={() => {}} />);
  ...
  it('calls onTabChange when tab is clicked', () => {
    ...
    render(<ProfileTabs tabs={mockTabs} activeTab="repositories" onTabChange={handleTabChange} />);
